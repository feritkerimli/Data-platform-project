...
from src.streaming.fake_order_producer import fake_order_stream
import io

def silver_load_fake_consumers(customers,order_items,order_payments,orders,products,sellers):
